...
/**
 * FileToUrl filter form base class.
 *
 * @package    Circle
 * @subpackage filter
 ...
 */
abstract class BaseFileToUrlFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('file_to_url_filters[%s]');
